...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{expA/egl-s4-A.png}
	\caption{Caption of the figure.}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{expA/egl-s4-C.png}
	\caption{Caption of the figure.}
	\label{fig:your-figure}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{expB/egl-e1-A.png}
	\caption{Caption of the figure.}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{expB/egl-e1-C.png}
	\caption{Caption of the figure.}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{expB/egl-e4-A.png}
	\caption{Caption of the figure.}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{expB/egl-e4-C.png}
	\caption{Caption of the figure.}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{expB/egl-s1-A.png}
	\caption{Caption of the figure.}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{expA/egl-s1-C.png}
	\caption{Caption of the figure.}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{expB/egl-s4-A.png}
	\caption{Caption of the figure.}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\textwidth]{expB/egl-s4-C.png}
	\caption{Caption of the figure.}
	\label{fig:your-figure}
\end{figure}
