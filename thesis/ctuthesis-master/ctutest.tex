...
%	\begin{tabular}{|c|c|cc|cc|cc|c|}
%		\hline
%		\textbf{Dataset}&&\multicolumn{2}{c|}{\textbf{Vanilla100}}&\multicolumn{2}{c|}{\textbf{Node100}}&\multicolumn{2}{c|}{\textbf{Edge20}}&\textbf{Optimal} \\ \hline
%		&vehicles&median&best&median&best&median&best& \\ \hline
...
%		egl-s4-A &19& 13192&12951&13272&12982&12678&12561&12140 \\ \hline
%		egl-s4-C &36& 21720&21245&21909&21626&21210&21071&20380\\ \hline
%	\end{tabular}
%\end{table}
%
%
...
%	\begin{tabular}{|c|c|cc|cc|cc|c|}
%		\hline
%		\textbf{Dataset}&&\multicolumn{2}{c|}{\textbf{Basic20}}&\multicolumn{2}{c|}{\textbf{Node20}}&\multicolumn{2}{c|}{\textbf{Edge20}}&\textbf{Optimal}\\ \hline
%		&vehicles&median&best&median&best&median&best&\\ \hhline{|=|=|==|==|==|=|}
...
%	\label{tab:experimentCc}
%	\begin{tabular}{|c|c|cc|cc|cc|c|}
%		\hline
%		\textbf{Dataset}&&\multicolumn{2}{c|}{\textbf{Basic200}}&\multicolumn{2}{c|}{\textbf{Node200}}&\multicolumn{2}{c|}{\textbf{Edge20}}&\textbf{Optimal}\\ \hline
%		&vehicles&median&best&median&best&median&best&\\ \hhline{|=|=|==|==|==|=|}
%		egl-e1-A&5&3561&3548&3548&3548&3548&3548&3548\\ \hline
%		egl-e1-C&10&5728&5677&5687&5634&5680&5613&5595\\ \hline
%		egl-e4-A&9&6689&6598&6732&6594&6611&6507&6395\\ \hline
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expA/egl-e1-A.png}
	\caption{Experiment A}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expA/egl-e1-C.png}
	\caption{Experiment A}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expA/egl-e4-A.png}
	\caption{Experiment A}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expA/egl-e4-C.png}
	\caption{Experiment A}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expA/egl-s1-A.png}
	\caption{Experiment A}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expA/egl-s1-C.png}
	\caption{Experiment A}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expA/egl-s4-A.png}
	\caption{Experiment A}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expA/egl-s4-C.png}
	\caption{Experiment A}
	\label{fig:your-figure}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expB/egl-e1-A.png}
	\caption{Experiment B}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expB/egl-e1-C.png}
	\caption{Experiment B}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expB/egl-e4-A.png}
	\caption{Experiment B}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expB/egl-e4-C.png}
	\caption{Experiment B}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expB/egl-s1-A.png}
	\caption{Experiment B}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expB/egl-s1-C.png}
	\caption{Experiment B}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expB/egl-s4-A.png}
	\caption{Experiment B}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expB/egl-s4-C.png}
	\caption{Experiment B}
	\label{fig:your-figure}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expC/egl-e1-A.png}
	\caption{Experiment C}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expC/egl-e1-C.png}
	\caption{Experiment C}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expC/egl-e4-A.png}
	\caption{Experiment C}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expC/egl-e4-C.png}
	\caption{Experiment C}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expC/egl-s1-A.png}
	\caption{Experiment C}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expC/egl-s1-C.png}
	\caption{Experiment C}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expC/egl-s4-A.png}
	\caption{Experiment C}
	\label{fig:your-figure}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{expC/egl-s4-C.png}
	\caption{Experiment C}
	\label{fig:your-figure}
\end{figure}
